...
\
label.label.label-danger.border.nosel.fa.fa-close.fr::before {
\
color: #f00;
\
}
...
\
    color: #fff!important;
\
background-image: radial-gradient(circle,#3b5678,#3b5678,#738bab)!important;
\
}
\
div.label.border.mini.label-danger.fr.fa.fa-times {
\
margin-top: -30px;
\
    margin-right: 2px;
...
\
.ae.fa.label.label-primary.fa-microphone {
\
...
\
    height: 20px;
\
background-color: #3b5678e6!important;
\
...
\
    color: #ffffff;
\
background-color: #3b5678!important; 
\
   border-radius: 0px;
\
...
\
.ae.fa.label.label-primary.fa-users.btnClAlGr:before {
\
  content:"\\f0c0";
\
}
...
\
    border-radius: 50px;
\
    background: url(https://mrkzgulfup.com/uploads/164114988564421.png)100% 100% / 100% 100% no-repeat!important;
\
}
\
span.fa.fa-microphone::before {
\
display: none!important;
\
...
45deg
\
,rgba(255,255,255,.2) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.2) 50%,rgba(255,255,255,.2) 75%,transparent 75%,transparent)!important;
\
}
\
...
$('div#l1 button.btn.btn-primary').bind('click', function () {
    alert('اهلا وسهلا بكم في شات مرحبا للجوال ❤️ سجل عضوية تحصل على 5000 لايك وزخرفة :: طريقة التسجيل اضغط على خيار (تـسجيـل )  (اكتب اسمك المستعار + كلمة المرور ) وبعدها اضغط دخول')
});
...
$('label.ae.fa.label.label-primary.fa-commenting-o').html('<span class="bwall  minix badge border" style="margin-top:-8px;padding:1px 4px;">0</span>');
$(`${''}${'<div class="laith2" style="padding:2px;background-color:white;z-index:1;color:lightslategrey;font-size: small!important;height:22px;">Copyright © 2021 <a title="mobail.host" class="laith" href="https://mobail.host/">موبايل هوست</a>. All Rights Reserved</div>'}${''}`).insertAfter($('.lonline'))
